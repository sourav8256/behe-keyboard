...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (DataUtils.isExternalStorageReadable() && DataUtils.isExternalStorageWritable() && !backupFolder.exists())
            backupFolder.mkdir();

        backupPath = new File(backupFolder, DataUtils.BACKUP_FILE_NAME);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (searchActive) {
            ...
            try {
                ...
                intent.putExtra(DataUtils.NOTE_TITLE, notes.getJSONObject(newPosition).getString(DataUtils.NOTE_TITLE));
                intent.putExtra(DataUtils.NOTE_BODY, notes.getJSONObject(newPosition).getString(DataUtils.NOTE_BODY));
                intent.putExtra(DataUtils.NOTE_COLOUR, notes.getJSONObject(newPosition).getString(DataUtils.NOTE_COLOUR));
                intent.putExtra(DataUtils.NOTE_FONT_SIZE, notes.getJSONObject(newPosition).getInt(DataUtils.NOTE_FONT_SIZE));
